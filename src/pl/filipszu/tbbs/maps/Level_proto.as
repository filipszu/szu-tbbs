...
package pl.filipszu.tbbs.maps
{
	...
	public class Level_proto
	{
		...
		public var nestPoint:FlxPoint = new FlxPoint(boundsMinX, boundsMinY);
		public var nestRotated:Boolean = false;
		public var birthPlaces:Array = new Array();
		public var MAX_WORMS_CATCH:uint = 0;
		
		public function Level_proto() { 
